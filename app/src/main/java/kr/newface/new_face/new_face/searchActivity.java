...
public class searchActivity extends AppCompatActivity {
  /*  CheckBox s1 = (CheckBox) findViewById(R.id.s1);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(s3.isChecked()){search[2]=1;}
        else{search[2]=0;}
        if(s4.isChecked()){search[3]=1;}
        else{search[3]=0;}
        if(s5.isChecked()){search[4]=1;}
        else{search[4]=0;}
        if(s6.isChecked()){search[5]=1;}
        else{search[5]=0;}
        if(s7.isChecked()){search[6]=1;}
        else{search[6]=0;}
        if(s8.isChecked()){search[7]=1;}
        else{search[7]=0;}
        if(s9.isChecked()){search[8]=1;}
        else{search[8]=0;}
        if(s10.isChecked()){search[9]=1;}
        else{search[9]=0;}
        if(s11.isChecked()){search[10]=1;}
        else{search[10]=0;}
        if(s12.isChecked()){search[11]=1;}
        else{search[11]=0;}
        if(s13.isChecked()){search[12]=1;}
        else{search[12]=0;}
        if(s14.isChecked()){search[13]=1;}
        else{search[13]=0;}
        if(s15.isChecked()){search[14]=1;}
        else{search[14]=0;}
        if(s16.isChecked()){search[15]=1;}
        else{search[15]=0;}
        if(s17.isChecked()){search[16]=1;}
        else{search[16]=0;}
        if(s18.isChecked()){search[17]=1;}
        else{search[17]=0;}
        if(s19.isChecked()){search[18]=1;}
        else{search[18]=0;}
        if(s20.isChecked()){search[19]=1;}
        else{search[19]=0;}
        if(s21.isChecked()){search[20]=1;}
        else{search[20]=0;}
        if(s22.isChecked()){search[21]=1;}
        else{search[21]=0;}
        if(s23.isChecked()){search[22]=1;}
        else{search[22]=0;}
        if(s24.isChecked()){search[23]=1;}
        else{search[23]=0;}
        if(s25.isChecked()){search[24]=1;}
        else{search[24]=0;}
        if(s26.isChecked()){search[25]=1;}
        else{search[25]=0;}
